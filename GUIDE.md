...
2. 内测阶段的项目须在首页README的项目标题后标注其处于【Alpha内测版】，例如：pumpkin-book（Alpha内测版），教程类的项目还须在每页的顶部位置显著标注【Alpha内测版本警告：此为早期内部构建版本，内容尚不完整且错误较多，仅供预览与测试，欢迎大家提Issue反馈问题或建议。】；
...
2. 公测阶段的项目须在首页README的项目标题后标注其处于【Beta公测版】，例如：pumpkin-book（Beta公测版），教程类的项目还须在每页的顶部位置显著标注【Beta公测版本提示：教程主体已完成，正在优化细节，欢迎大家提Issue反馈问题或建议。】；
