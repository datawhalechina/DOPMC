...
2. 内测阶段的项目须在首页README的项目标题后标注其处于 **【⚠️ Alpha内测版】** ，并且在顶部显著标注 **【⚠️ Alpha内测版本警告：此为早期内部构建版本，尚不完整且可能存在错误，欢迎大家提Issue反馈问题或建议。】**，教程类的项目还须在每个内容页的顶部也进行相同标注，样例参见[模板仓库](https://github.com/datawhalechina/repo-template)；
...
2. 公测阶段的项目须在首页README的项目标题后标注其处于 **【🧪 Beta公测版】** ，并且在顶部显著标注 **【🧪 Beta公测版本提示：教程主体已完成，正在优化细节，欢迎大家提Issue反馈问题或建议。】** ，教程类的项目还须在每个内容页的顶部也进行相同标注，样例参见[模板仓库](https://github.com/datawhalechina/repo-template)；
