<h1 align="center">Datawhale开源机遇清单</h1>

## 前言
为了便于贡献者们参与Datawhale社区建设，现公开发布机遇清单，公示社区当前重点建设以及未来布局的课题，供不知从何下手的贡献者们挑选，如果下述课题中有你想做的，选中以后即可按照<a target="_blank" href="https://github.com/datawhalechina/DOPMC/blob/main/GUIDE.md">《Datawhale开源项目指南》</a>启动项目，同时本清单持续征集新课题，有各种奇思妙想的课题想提议给我们的敬请联系微信：at-Sm1les

## 机遇清单
| 课题名 | 简介 | 提议者 |
| :----:| :----: | :----: |
| AI工具使用教程 | 当前的各种AI模型和AI工具能力其实已经非常强大，但是很多人还处于不知道、想用但不会用、会用一点但用不好的阶段，为了加速全民AI时代的到来，我们Datawhale作为国内头部AI学习社区，除了教科班同学学会如何开发AI以外，还有责任与义务帮助任何想用AI的普罗大众学会如何使用AI，因此任何教学AI工具使用的教程我们都非常欢迎~ | [Sm1les](https://github.com/Sm1les) |
| OpenClaw | 欢迎立项openclaw系列的项目，例如：复现/手搓教程、配套插件开发教程、安装教程 | [Sm1les](https://github.com/Sm1les) |
| Harness Engineering | Context Engineering的升级版，有关这方面的教程、项目、工具等任意题材都欢迎 | [Sm1les](https://github.com/Sm1les) |
